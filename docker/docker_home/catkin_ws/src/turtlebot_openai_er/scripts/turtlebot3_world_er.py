...
from turtlebot3_openai_er import turtlebot3_env_er
...
register(
        id='TurtleBot3World-v1',
        entry_point='turtlebot3_openai_er:turtlebot3_world.TurtleBot3WorldEnv',
...
class TurtleBot3WorldEnv(turtlebot3_env.TurtleBot3Env):
	...
	camera = self.get_camera()
        ...
        return odom, discretized_observations, camera
